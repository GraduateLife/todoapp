    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow:
            '0 0 40px rgba(0,245,255,0.08), 0 16px 48px rgba(0,0,0,0.7)',
          maxHeight: '70vh',
          display: 'flex',
      ...
      >
        ...
        >
          <div>
            <p
              className="font-mono text-[9px] tracking-[0.22em] uppercase opacity-50 mb-0.5"
        ...
        <div className="overflow-y-auto flex-1 px-3 py-2">
          {archived.length === 0 ? (
            <p
              className="font-mono text-[0.75rem] text-center py-8 opacity-30"
              style={{ color: 'var(--rf-text-dim)' }}
            >
              no archived items
            </p>
              ...
              {archived.map((todo) => (
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      background: `var(--rf-${todo.color === 'cyan' ? 'cyan' : todo.color === 'pink' ? 'pink' : todo.color === 'amber' ? 'amber' : todo.color === 'green' ? 'green' : 'purple'})`,
                      opacity: 0.6,
                    }}
                  />
